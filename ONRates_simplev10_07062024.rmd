...
- tends to fall before holidays and rise after
- Each non trading day raises the variance of the next trading day by 67 percent
- positive response to penalty rate 1.240     (0.465)
- increases on FOMC announcements days 0.783  (0.262)
- significant EGARCH parameters: persistence in underlying volatility of liquidity shock, very fat tailed distribution of errors df of student t 2.94 significantly different than 3 $\rho=0.747$
