...
Bertolini, Bertola, Prati (), Garaet al  () and Benzoni observe volatility in interbank rates from Fed interventions:
...
#arima_params 
#                    ar1              intercept   oneday_beforeholiday threeday_beforeholiday  -->
#            0.844553112            2.020623157            0.103042167           -0.101280887  -->
#    oneday_afterholiday             endquarter                endyear                 Monday  -->
#            0.039598463            0.141173996            0.101622528           -0.002546271  -->
#                 Friday                   fomc              fomcindex                      z  -->
#           -0.013815827            0.009543357           -0.281835631           -0.702084727  -->
#                     nt                  absnu                     nu  -->
#            1.622541417           -0.009251604           -0.009526509  -->
...
<!--
#DELETE
```{r garchsimple, eval=FALSE, echo=FALSE, results='hide', message=FALSE, warning=FALSE} 
...
#   bbp_params_Coefficients = c(NA, NA, -0.026, -0.018, 0.062, 0.206, -0.185, NA, NA, NA, NA, NA, NA, NA, NA),
#   bbp_params_StdErrors = c(NA, NA, 0.017, 0.008, 0.018, 0.034, 0.078, NA, NA, NA, NA, NA, NA, 0.069, 0.042),
...
egarch_bbp
 ...
 # Create a table using xtable-------------------- for overnight EFFR
egarch_bbp_table <- xtable(egarch_bbp, caption = "EGARCH (1,1) sample rates 3/4/2016 to 12/14/2023", label="tab:egarch_bbp", caption.placement="bottom", comment = FALSE)
egarch_bbp_table
```     
-->
...
For comparison with other methods, I replicate Bertolini, Bertola, Prati (2000) empirical model of the volatility of the Federal Funds rate. Their objectives were to evaluate the time series properties of the  Fed Funds rate: 
- mean reversion behavior in  the Fed Funds
- main patterns of volatility in the Fed funds rates.

They note that although overnight wholesale money market rates change in response to monetary policy and other shocks, they quick revert to changes in the unsecured federal funds rate (FFR) or administered rates. Other findings were that the Fed funds rate:
...
They include the affect of level shift of changes in the target rate $r^*_t$, or $r^{\ast}_t$, on interest rates:
$\mu_t= r_{t-1} +\delta_t + \kappa k_t + \iota(r^*_t-r{t^*-1}$
...
#\emph{EGARCH results for 2016-2023}  
...
The calendar effect variables included in the dummy $h_t. 
...
(Table (\@ref(tab:egarch_bbp_table)        
The response of the FFR to dummies representing inividual dates similar in full sample but different signs, very small compared to Bertolini el al post 1994.

The only agreement the day ffects of this replication with results in 2016-2023from earlier data is 

- Quarter end  
- Three day before holiday "
- One day after holiday:

<!--
ADD TABLE
[forgot constant, AR1]

                                                      full sample          post 1994
...
\emph{comparison of finding} A summary of their findings:
the variance of the FFR rate in the full sample:
...
<!--
An older run before I added more variables
