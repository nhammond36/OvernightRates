...
They include target changes to capture the level shift changes of target rates affect on interest rates:
...
\emph{Arima 2016-2023}
Reserve requirements for depositor banks and institutions at the Federal Reserve, in place during Bertolini et al (2000) study, were not present during this replication of their empirical model from 2016 to 2023.
...
Replicating their model for the daily Federal funds rate from  2016 through 2023 I eliminated the  dummy days for the reserve period (see (Table (\@ref(tab:arima_both)).  
...
The only agreement is quarter end 2016-2023 qnd full cample
