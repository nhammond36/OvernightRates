...
# Introduction
This paper explores the impact of monetary policy on money market rates in the market for repurchase agreements, a key source of liquidity funding market for primary dealers who required to intermediate new issues of US Treasury debt and other participants. The market for repurchase 'repo' agreements has grown into a $4 trillion-a-day funding market to provide liquidity to the Federal Reserves' primary dealers and other financial participants:  hedge funds, money market funds, GSEs and private investors. Identifying the behavior of rates in these markets and the mutual effect between repo market and central bank rates has thus become crucial to understanding the monetary system.

Bank reserves and deposits are regularly swapped for Treasuries and other securities, which are then swapped for repos used to fund loans, obtain leverage, and many other functions. The major objective of the repo market is to provide consistent liquidity to financial players 
...
* Money moarket rates cluster around the Federal Funds rate (FFR)
* These ates quickly response to changes in the FFR and administrative rates, interest on reserves (IORB), the overnight reverse repo rate (ON/RRP)
...
#print(charsample, include.rownames = FALSE, caption.placement = "top")
```
...
#print(ratesamplestats, include.rownames = FALSE, caption.placement = "top")
```
...
print(charnorm, include.rownames = FALSE, caption.placement = "top")
...
```{r, tab.caption="Rate characteristics normalcy 3/04/2016-7/31/2019", eval=TRUE,echo=FALSE}
begn <- c(1, 859, 923, 1014, 1519, 1)
endn <- c(858, 922, 1013, 1518, 1957, 1957)
library(xtable)
...
print(normstats[, -1], include.rownames = FALSE, caption.placement = "top")
```
...
print(charadj, include.rownames = FALSE, caption.placement = "top")
```
...
print(charcovid, include.rownames = FALSE, caption.placement = "top")
```
...
print(covidstats, include.rownames = FALSE, caption.placement = "top")
```
...
print(charzlb, include.rownames = FALSE, caption.placement = "top")
```
...
print(zlbstats, include.rownames = FALSE, caption.placement = "top")
```
...
print(charinflation, include.rownames = FALSE, caption.placement = "top")
```
...
print(inflationstats, include.rownames = FALSE, caption.placement = "top")
```
