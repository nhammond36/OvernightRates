...
How overnight rates primary funding markets respond to changes in FOMC policy.overnight reference rates reveals that they track and cluster around the policy rate, the effective Federal rate (EFFR),  respond quickly to changes in the EFFR or the administered rates IORB and O/N RRP (Figure \@ref(fig:Sample reference rates 3/4/2016-12/14/2023)). Another inquiry is how much the Federal Reserve is willing to offset volatility in its policy range when managing the FFR with the targe rates specified by the FOMC.

The rate and volume data from 2016 through 2023 cover several policy regimes of the FED, sequential 25 point increases from 2016 to mid 2019 normalcy,followed by plus or minus 25 bp from August to November 2019,
...
through a periods of adjustment; a series of 25 bp increased with QE during covid,  a period of the zero lower bound, and sequential rate increased during the taming of inflation. During this period, repo funding markets became a major source of liquidity for primary dealers who are required to intermediate new US Treasury uses, hedge funds, GSEs, MMFS and other participants. The Tri-Party General Collateral Rate (TGCR), is the base layer of repurchase agreement (repo) transactions where transactions are secured by Treasury securities (figure  \@ref(fig:Sample rates 3/4/2016-12/14/2023)). The Tri-Party General Collateral Rate (TGCR), the base layer of repos, is a measure of rates on overnight, specific-counterparty tri-party general collateral repurchase agreement (repo) transactions secured by Treasury securities.The Fed conducts OMO in the TGCR, both  borrowing and lending operations. Primary dealers, the borrowers, obtain cheapest rates from lenders, asset managers , then lend at a spread in other repo markets. (Reference CONCODA), The Broad General Collateral Rate (BGCR) is the market where primary dealers intermediate cash to leveraged investors (hedge funds). The Secured Overnight Financing Rate (SOFR), Fed’s broadest measure of repo rates, expresses the average cost of overnight ?
...
• covid 11/1/2019 3/16/2020
• zlb 3/17/2020- 3/16/2022
• Taming inflation 03/17/2022 - 12/14/20231. Normalcy 3/4/2016 to 7/31/2019
2. Mid cycle adjustment 8/1/2019 to 10/31/2019
3. Covid 11/1/2019 to 3/16/2020
4. Zero lower bound 3/17/2020 to 3/16/2022
5. Taming inflation 03/17/2022 - 12/14/2023
...
• Taming inflation 03/17/2022 - 12/14/2023
 ...
 (Reference CONCODA) to \@ref(fig:Sample rates 3/4/2016-12/14/2023),  These funding rates . 
...
The rate data from the Federal Reserve Data Download Program, average volume weighted medians better measure the central tendency of daily rates since rates data record outliers (Figure \@ref(fig:EFFR Key percentiles of the sample 3/4/2016-12/14/2023)).  The IQR, the 75th minus the 25 percentile of the data, providea measure of variability for skewed distributions, describing how rates cluster around the median rate, 50 percent of the data lie.  The  range. the 99th minus the one percentile, tell us the magnitude of the outliers, some two percent of the values of rates in the data (Table (\@ref(tab:Rate characteristics 2016-2023) ). is a measure of variability that tell us the extreme values of outliers in rates.  

[INTEGRATE THIS PARAGRAPH]
The median Tri-Party General Collateral Rate (TGCR), the Broad General Collateral Rate (BGCR), and Secured Overnight Financing Rate (SOFR) cluster around the EFFR at 157 bp. Outliers that make up two percent of the data, the highest minus lowest rates are 23.36, 13.86, 16.11, and 14.51 basis point for the wholesale rates TGCR, BGCR, and SOFR.  TGCR and BGCR 132.83 and 132.84, SOFR 134.08. [range from 123 to 134 bp. Median rates in the sample ] 

\emph{Funding rates track the FFR}
Median funding rates  closely track the the policy rate, the EFFR (Table \@ref(tab:Sample statistics 2016-2023)). The similar average median rates and percentiles illustrate the tendency of other rates to cluster around the EFFR. The average median EFFR over the full sample is 157 basis point (bp), the money market rates about 132-134 bp, TGCR  132  bp,  BGCR 133 bp, the SOFR benchmark 134 bp.The percentiles of rates reflect the same clustering around the EFFR as do their medians.

OR half the data are clustered tightly around median rates. Half the the EFFR, TGCR, and BGCR rates are within one basis point. The SOFR, 4 basis points... moments of the data show overnight rates are highly skewed with fatter tails

\emph{Variability: clustering of runding rates  around their median (IQR)}
the IQR, a measure of variability for skewed distributions and less influenced by extreme values, are small, indicate these reference rates are tightly clustered around their median values. Fifty percent of EFFR daily rates fall within 157.71-156.15 bp, an ICR of  1.56 basis points, the TGCR and BGCR cluster even more tightly, under one bp (133), SOHR  shows greater dispersion, 4.2 bp. (136.70-132.50).  


\emph{Outliers}
Overnight rates are highly skewed with fatter tails.
\url{https://statisticsbyjim.com/basics/interquartile-range/}
The magnitude of outliers, the 2 percent of the data in the range of the data, is 14 to 16 bp for all rates.  Is this large or small? large range means high variability, a small range means low variability.  Most ranges are double digit to 41.26 percent SOFR data as outliers during the adjustment period. In contrast, the range of the EFFR and the money market rates, TGCR, BGCR, and SOFR in the sample are some 14 to 16 basis points. 
...
```{r, fig.cap= "EFFR Key percentiles of the sample 3/4/2016-12/14/2023", echo=FALSE,fig.num=TRUE, results='asis'}
  library(ggplot2)
          sample<-quantilesE
          sdate <- quantilesE[, 1]
...
Average median rates for the sample are 157 bp for the EFFR, and some 133-134 bp for the money market rates and SOFR.

During the  during normalcy period the average median EFFR of 157 basis points (bp) increases steadily  from 36 basis points March 2016 to 214 bp July 2019 (\@ref(fig:Sample rates 3/4/2016-12/14/2023)).In 2019 rates during the adjustment period began a three month decline from August to October 2019.  Median EFFR is 184 bp during covid, rates plunge from 157 basis points in November 2019 to 15 bp in March 2020. Rates then hover near zero from March 2020 to March 2022 during the zero lower bound. Median rates during the inflation episode increased 233 percent of the the sample average as the Fed raised the FFR  in 25 or 50 basis point to tame inflation. Rtes rose steadily from March 2022 to 533 bp in December 2023.   Policy inertia,  Fed sequentially changes in rates is evident in all periods but most clearly as  the Fed fights inflation. The change median rates TGCR. BGCR, and SOFR is similar to the change in the median EFFR
...
for the sample, with the exception of SOFR are tightly clustered about their median values                            , 1.5 bp for the EFFR, and under one bpfor the money market rates .
ThE IQR shows all rates across policy episodes except SOFR, are tightly clustered around their median, under 2.35 bp, except during the adjustment, The money market rates are the most tightly clustered under 1 bp, hitting lows of 0.12 to 0,42. SOFR, the exception shows greater variability, both in the sample and in all episodes, reaching 27 bp during the adjustment period. 

EFFR1 1.56 1.22 12.84 2.35 1.54 1.62
TGCR1 0.92 0.22  6.71 0.31 0.12 3.26
BGCR1 0.96 0.23 15.29 0.42 0.15 3.36
SOFR1 4.20 3.30 25.88 7.37 3.05 5.68

for the sample, outliers range from 14 to 16 bp for all rates. Outliers soar during the period of adjustment, the EFFR 146 bp, the money market rates 275-300 bop, SOFR a whopping 954 bp. Outliers  during covid and the zero lower bound are lower than the sample range. OUtliers are larger than the sample during the taming of inflation 21 to 33 bp. But again SOFR shows the most variability in all episodes


EFFR2 15.99 17.65 146.05 11.71  7.33 23.36
TGCR2 13.86  5.62 274.56 11.21 11.21 32.27
BGCR2 16.11  8.48 300.67 16.02 11.86 33.34
SOFR2 14.51  8.53 954.53 19.46 14.44 21.35
