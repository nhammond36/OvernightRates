...
This is fGARCH not EGARCH
\begin{align*}
\sigma{^\lambda}_t &= \left(\omega + \sum_{j=1}^{m}\zeta_j\nu_jt \right) +  \left(\sum_{j=1}^{q} \alpha_j \sigma{^\lambda}_{t-j} ((abs(z_{t-j}-\eta_2j)- \eta_1j(z_{t-j}-\eta_2j))^\delta \right) +  \left(\sum_{j=1}^{p}\beta_j \sigma{^\lambda}_{t-j} \right) \\
a+b & = 10 
\end{align*}
...
Their mpirical model of Fed Funds rate
$r_t=\mu_t + \sigma_t\nu_t$
...
<!--
My first run of BBP's model:
 arima_params
                   ar1              intercept   oneday_beforeholiday threeday_beforeholiday 
           0.844456417            2.009397111            0.093360903           -0.098246819 
   oneday_afterholiday                endyear                 Monday                 Friday 
           0.037423414            0.195018825           -0.030454707           -0.007140097 
                     z                  absnu                     nu 
          -0.695365619           -0.002182032           -0.024434204 
> spec <- ugarchspec(
...
[1] "EGARCH Model Parameters:"
> print(coef(fit))
     omega     alpha1      beta1     gamma1 
-0.7213028  0.1173033  0.4522766  0.4943309 
> 
