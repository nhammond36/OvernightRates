...
```{r covidbox, fig.cap= "IQR and range of rates during covid period 11/1/2019-3/16/2020",echo=FALSE,fig.pos='H',fig.label="adjustbox"}
#(Figure \@ref(fig:EFFR Key percentiles durifig.label="covidbox"}
 library(ggplot2)
...
```{r zlbbox, fig.cap= "IQR and range of rates during zero lower bond period  3/17/2020-3/16/2022",echo=FALSE,fig.pos='H',fig.label="adjustbox"}
#(Figure \@ref(fig:EFFR Key percentiles during.label="zlbbox"}
...
```{r inflationbox, fig.cap="IQR and range of rates during inflation period 3/17/2022-12/14/2023", echo=FALSE, fig.pos='H',fig.label="adjustbox"}
#(Figure \@ref(fig:EFFR Key percentiles durifig.label="inflationbox"}
library(ggplot2)
library(reshape2)
