...
\emph{The adjustment period} (Figure \@ref(fig:ratesadjust)).
...
\emph{The pandemic}  (Figure \@ref(fig:ratescovid)).
...
\emph{The zero lower bound} (Figure \@ref(fig:rateszlb)) 
...
\emph{The Fed's fight to control inflation}  (Figure \@ref(fig:ratesinflation)).
