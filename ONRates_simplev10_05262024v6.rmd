...
```{r samplebox, fig.cap="EFFR IQR and range of the sample 3/4/2016-12/14/2023", echo=FALSE, warning=FALSE, message=FALSE, fig.label="samplebox"}
library(ggplot2)
...
```{r samplerates, fig.cap= "EFFR percentiles of the sample 3/4/2016-12/14/2023", echo=FALSE,fig.num=TRUE,warning=FALSE, message=FALSE,  results='asis'}
  library(ggplot2)
          sample<-quantilesE
          sdate <- quantilesE[, 1]
...
```{r ratestsnorm, fig.cap="Rates during normalcy period 3/4/2016-7/31/2019", echo=FALSE, warning=FALSE, message=FALSE,fig.label="ratestsnorm"}
library(ggplot2)
library(reshape2)
...
```{r ratesnorm, fig.cap="EFFR during normalcy period 3/4/2016-7/31/2019", echo=FALSE, warning=FALSE, message=FALSE, fig.label="ratesnorm"}
library(ggplot2)
library(reshape2)
normE<-my_envepisodes$norm
sdate <- normE[, 1]
...
```{r ratestscovid, fig.cap="Rates during covid 11/1/2019-3/16/2020", echo=FALSE, warning=FALSE, message=FALSE, fig.label="ratestscovid"}
library(ggplot2)
library(reshape2)
k=3  
library(ggplot2)
...
```{r ratescovid,fig.cap= "EFFR during covid period 11/1/2019-3/16/2020",echo=FALSE,warning=FALSE, message=FALSE, fig.pos='H',, fig.label="ratescovid"}
...
```{r adjustbox, fig.cap= "IQR and range of rates during mid cycle adustment period 8/1/2019-10/31/2019",echo=FALSE,fig.label="adjustbox"}
...
```{r normbox, fig.cap="IQR and range during normalcy period 3/4/2016-7/31/2019", echo=FALSE, warning=FALSE, message=FALSE, fig.label="normbox"}
library(ggplot2)
library(reshape2)
qnormE=quantilesE[bgn:edn,] # rate specific metrics  -->
qnormT=quantilesT[bgn:edn,] 
...
```{r covidbox, fig.cap= "IQR and range of rates during covid period 11/1/2019-3/16/2020",echo=FALSE,fig.label="covidbox"}
 library(ggplot2)
...
```{r zlbbox, fig.cap= "IQR and range of rates during zero lower bond period  3/17/2020-3/16/2022",echo=FALSE,fig.label="zlbbox"}
...
```{r inflationbox, fig.cap="IQR and range of rates during inflation period 3/17/2022-12/14/2023", echo=FALSE, fig.label="inflationbox"}
library(ggplot2)
library(reshape2)
...
print(xtable_norm,caption.placement = "bottom")
#, label = "tab:fomcnorm")
cat('\\label{tab:fomcnorm}')
```

```{r, fomcadjust, echo=FALSE, results='asis'}
library(xtable)
adjusttab<-fomc[10:11,]
xtable_adjust <- xtable(adjusttab,caption="Mid cycle adjustment 8/1/2019 to 10/31/2019", comment = FALSE)
print(xtable_adjust,caption.placement = "bottom")
#, label = "tab:fomcadjust")
cat('\\label{tab:fomcadjust}')
```
...
library(xtable)
covidtab<-fomc[12:13,]
xtable_covid <- xtable(covidtab, caption="Covid 11/1/2019 to 3/16/2020", comment = FALSE)
print(xtable_covid,caption.placement = "bottom")
#, label = "tab:fomccovid")
cat('\\label{tab:fomccovid}')
```

```{r, fomczlb, echo=FALSE, results='asis'}
library(xtable)
zlbtab<-fomc[14:22,]
xtable_zlb <- xtable(zlbtab, caption="Zero lower bound 3/17/2020 to 3/16/2022", comment = FALSE)
#print(xtable_zlb,caption.placement = "bottom", label = "tab:fomczlb")
print(xtable_zlb,caption.placement = "bottom")
cat('\\label{tab:fomczlb}')
```

```{r, fomcinflation, echo=FALSE, results='asis'}
library(xtable)
inflationtab<-fomc[24:37,]
xtable_inflation <- xtable(inflationtab, caption="Taming inflation 03/17/2022 to 12/14/2023", comment = FALSE)
#print(xtable_inflation,caption.placement = "bottom", label = "tab:fomcinflation")
print(xtable_inflation,caption.placement = "bottom")
# Manually add the LaTeX label
cat('\\label{tab:fomcinflation}')
```
