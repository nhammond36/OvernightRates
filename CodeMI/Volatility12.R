...
\url{https://tidystat.com/maximum-likelihood-estimation-for-linear-regression-in-r/#:~:text=To%20use%20maximum%20likelihood%20estimation%20%28MLE%29%20in%20linear,function.%20The%20following%20provides%20detailed%20R%20code%20examples}
...
#                                             
# The EGARCH model allows for assymetric effects of lagged inovations $\nu_{t-1}$ on each day's variance.
# The EGARCH(1,1) allows for persistent deviations of the log of its conditional variance from its unconditional variance
