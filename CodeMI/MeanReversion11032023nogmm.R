...
spread <- read.csv('C:/Users/Owner/Documents/Research/MonetaryPolicy/Data/Final data files/dailyovernightrates090923.csv',header=TRUE, sep=",",dec=".",stringsAsFactors=FALSE) 
...
# the median equals the average of the first and third quartiles)
...
# ---------- STATS sample volumes  are these median values
