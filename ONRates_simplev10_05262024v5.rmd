...
```{r, tab.cap="Rate statistics normalcy 3/04/2016-7/31/2019", eval=TRUE,echo=FALSE, results='asis',warning=FALSE, message=FALSE}
begn <- c(1, 859, 923, 1014, 1519, 1)
endn <- c(858, 922, 1013, 1518, 1957, 1957)
library(xtable)
k <- 1 
...
\FloatBarrier
```{r ratestsnorm, fig.cap="Rates during normalcy period 3/4/2016-7/31/2019", echo=FALSE, fig.num=TRUE, warning=FALSE, message=FALSE}
library(ggplot2)
library(reshape2)
...
\FloatBarrier 
```{r ratesnorm, fig.cap= "EFFR during normalcy period 3/4/2016-7/31/2019", fig.num=TRUE, echo=FALSE, results='asis',warning=FALSE, message=FALSE, fig.pos='H'}
...
```{r, tab.cap="Rate characteristics mid cycle adjustment 8/1/2019-10/31/2019", echo=FALSE,results='asis',warning=FALSE, message=FALSE}
library(xtable)
k=2  
begn <- c(1, 859, 923, 1014, 1519, 1)
endn <- c(858, 922, 1013, 1518, 1957, 1957)
...
```{r, tab.cap="Rate statistics mid cycle adjustment 8/1/2019-10/31/2019",echo=FALSE,results='asis',warning=FALSE, message=FALSE}
library(xtable)
k=2  
begn <- c(1, 859, 923, 1014, 1519, 1)
endn <- c(858, 922, 1013, 1518, 1957, 1957)
...
```{r ratestsadjust,fig.cap="Rates during mid cycle adjustment 8/1/2019-10/31/2019", echo=FALSE,fig.num=TRUE, results='asis',warning=FALSE, message=FALSE, fig.pos='H'}
...
```{r ratesadjust, fig.cap= "EFFR during adjustment period 8/1/2019-10/31/2019", eval=TRUE, echo=FALSE,fig.num=TRUE, results='asis',warning=FALSE, message=FALSE, fig.pos='H'}
...
```{r, tab.cap="Rate characteristics covid 11/1/2019-3/16/2020", echo=FALSE,results='asis',warning=FALSE, message=FALSE} 
library(xtable)
k=3  
begn<-c(1,859,923,1014,1519,1)
endn<-c(858,922,1013,1518,1957,1957)
...
```{r, tab.cap="Rate statistics covid 11/1/2019-3/16/2020" , echo=FALSE,results='asis',warning=FALSE, message=FALSE}
library(xtable)
categories <- c("EFFR", "TGCR", "BGCR", "SOFR")
...
```{r ratestscovid, fig.cap= "Rates during covid 11/1/2019-3/16/2020",echo=FALSE,fig.num=TRUE,results='asis',warning=FALSE, message=FALSE, fig.pos='H'}
#(see Figure \@ref(fig:Rates during covid 11/1/2019-3/16/2020)
...
```{r ratescovid,fig.cap= "EFFR during covid period 11/1/2019-3/16/2020",echo=FALSE,fig.num=TRUE,results='asis',warning=FALSE, message=FALSE, fig.pos='H'}
...
```{r, tab.cap="Rate characteristics zero lower bound 3/17/2020-3/16/2022", echo=FALSE, eval=TRUE, cache=FALSE,results='asis',warning=FALSE, message=FALSE}
library(xtable)
k=4  
begn<-c(1,859,923,1014,1519,1)
endn<-c(858,922,1013,1518,1957,1957)
...
```{r, tab.cap="Rate statistics zero lower bound 3/17/2020-3/16/2022",echo=FALSE,results='asis',warning=FALSE, message=FALSE}
categories <- c("EFFR", "TGCR", "BGCR", "SOFR")
library(xtable)
...
```{r ratestszlb, fig.cap= "Rates during zero lower bound 3/17/2020-3/16/2022",echo=FALSE,fig.num=TRUE,results='asis',warning=FALSE, message=FALSE, fig.pos='H'}
...
```{r rateszlb, EFFR during zero lower bound (zlb) period 3/17/2020-3/16/2022, echo=FALSE}
rates=2
vol=3
targetup = 3
targetdown = 4
...
```{r rateszlb, fig.cap= "EFFR during zero lower bound (zlb) period 3/17/2020-3/16/2022",echo=FALSE,fig.num=TRUE,warning=FALSE, message=FALSE, fig.pos='H'}
...
```{r, tab.cap="Rate characteristics Taming inflation 03/17/2022-12/14/2023", echo=FALSE,results='asis',warning=FALSE, message=FALSE}
library(xtable)
k=5 
begn<-c(1,859,923,1014,1519,1)
endn<-c(858,922,1013,1518,1957,1957)
...
```{r, tab.cap="Rate statistics Taming inflation 03/17/2022-12/14/2023", echo=FALSE,results='asis',warning=FALSE, message=FALSE}
library(xtable)
k <- 5 
begn <- c(1, 859, 923, 1014, 1519, 1)
endn <- c(858, 922, 1013, 1518, 1957, 1957)
...
```{r ratestsinflation, fig.cap= "Rates during Taming inflation 3/17/2022-12/14/2023",echo=FALSE,fig.num=TRUE,results='asis',warning=FALSE, message=FALSE, fig.pos='H'}
...
```{r ratesinflation, EFFR during inflation period 03/17/2022-12/14/2023, echo=FALSE}
rates=2
vol=3
targetup = 4
targetdown = 5
...
```{r ratesinflation, fig.cap="EFFR during inflation period 3/17/2022-12/14/2023",echo=FALSE,fig.num=TRUE,warning=FALSE, message=FALSE, fig.pos='H'}
...
```{r , fig.cap= "IQR and range of rates during normalcy period 3/4/2016-7/31/2019",echo=FALSE,fig.num=TRUE,results='asis'}
...
<!--
{r , fig.cap= "IQR and range of rates during normalcy period 3/4/2016-7/31/2019",echo=FALSE,fig.num=TRUE,results='asis'}
(Figure \@ref(fig:IQR and range of rates during normalcy period 3/4/2016-7/31/2019))

{r , fig.cap= "IQR and range of rates during normalcy period 3/4/2016-7/31/2019",echo=FALSE,fig.num=TRUE,results='asis'}

(Figure \@ref(fig:IQR and range of rates during mid cycle adjustment period 8/1/2019-10/31/2019))
`{r , fig.capt= "IQR and range of rates during mid cycle adustment period 8/1/2019-10/31/2019",echo=FALSE,fig.num=TRUE,results='asis'}

{r , fig.capt= "IQR and range of rates during covid period 11/1/2019-3/16/2020",echo=FALSE,fig.num=TRUE,results='asis'}
(Figure \@ref(fig:IQR and range of rates during covid period 11/1/2019-3/16/2020))

{r , fig.cap= "IQR and range of rates during zero lower bond period  3/17/2020-3/16/2022",echo=FALSE,fig.num=TRUE,results='asis'}
(Figure \@ref(fig:IQR and range of rates during zero lower bond period  3/17/2020-3/16/2022))

{r , fig.cap= "IQR and range of rates during inflation period 3/17/2022-12/14/2023",echo=FALSE,fig.num=TRUE,results='asis'}
(Figure \@ref(fig:IQR and range of rates during inflation period 3/17/2022-12/14/2023))
-->


```{r , fig.cap= "IQR and range of rates during mid cycle adustment period 8/1/2019-10/31/2019",echo=FALSE,fig.num=TRUE,results='asis'}
...
```{r , fig.cap= "IQR and range of rates during covid period 11/1/2019-3/16/2020",echo=FALSE,fig.num=TRUE,results='asis'}
#(Figure \@ref(fig:IQR and range of rates during covid period 11/1/2019-3/16/2020)
 library(ggplot2)
...
<!--
https://github.com/rstudio/rmarkdown-cookbook/issues/94
...
<!--
(Figure \@ref{fig:Rates during normalcy period 3/4/2016-7/31/2019)).
-->
...
<!--
(Figure \@ref(fig:Rates during mid cycle adjustment 8/1/2019-10/31/2019)).
-->
...
<!--
(Figure \@ref(fig:Rates during covid 11/1/2019-3/16/2020)).
-->
...
## Percentiles
Percentiles of the EFFR during the normalcy period (Figure \@ref(ratesnorm)
<!--
(Figure \@ref(fig:EFFR during normalcy period 3/4/2016-7/31/2019)). 
-->
The EFFR, median and IQR values are withing the FOMC target ranges (the step function for the lower and upper target rates, TargetDe, and TargetUe). The IQR and outliers are illustrated Figure \@ref(fig:IQR and range of rates during normalcy period 3/4/2016-7/31/2019).


Percentiles of the EFFR during the adjustment period (Figure \@ref(ratesadjust)
<!--
(Figure \@ref(fig:EFFR during adjustment period 8/1/2019-10/31/2019)). 
-->
The outlierS from the spike in repo rates September 2019 is the only time the FFR was not within the FOMC target range (Figure \@ref{fig:IQR and range of rates during mid cycle adjustment period 8/1/2019-10/31/2019).

Percentiles of the EFFR during the pandemic  (Figure \@ref(ratescovid)
<!--
(Figure \@ref{fig:EFFR during covid period 11/1/2019-3/16/2020})
--> 
The outliers from the March 20, 2020 dash for cash are outside the FOMC target rate (Figure \@ref(fig:IQR and range of rates during covid period 11/1/2019-3/16/2020)).

Percentiles of the EFFR during the zero lower bound  (Figure \@ref(fig:rateszlb) 
<!--
(Figure \@ref(fig:EFFR during zero lower bound (Zlb) period 3/17/2020-3/16/2022))
--> 
and (Figure \@ref(fig:IQR and range of rates during zero lower bond period  3/17/2020-3/16/2022)).


Percentiles of the EFFR during the Fed's fight to control inflation  (Figure \@ref(fig:ratesinflation) 
<!--
(Figure \@ref(fig:EFFR during inflation period 3/17/2022-12/14/2023)) 
-->
The EFFR and the IQR are within the FOMC target rates (Figure \@ref(fig:IQR and range of rates during inflation period 3/17/2022-12/14/2023)).
