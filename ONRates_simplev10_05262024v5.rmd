...
## Monetary policy during the sample period 2016-2023
  Before the Great Financial Crisis (GFC)  of 2008, Federal Reserve policy was conducted by open market operations (OMO), trading a limited supply of central bank deposits (reserves and securities in the interbank Federal Funds market. To address the great financial crisis (GFC), the Fed made large scale asset purchases (LSAPs) from 2008 to 2014 - QE,QE1, QE2, and QE3, funded by US Treasury sale of Treasury bills. LSAPs substituted reserve balances for a large part of its SOMA Treasury holdings. Swamped in reserves, banks had no need to borrow in the Fed Funds market. From 2010 to late 2019, reserves went through a full expansion-contraction cycle  and expanded  again in early 2020, $\$$8 trillion from 2010 and 2019 to $\$$19 trillion (2014 and 2021) of banks’ assets. {?}

  To regain control over the FFR after this major increase in liquidity, the Fed experimented with with different policies during the seven year period of our sample 2016-2023. 
...
\emph{the reverse repurchase facility}
   Fed opened its RRP (reverse repo) facility in 2013 to address the excess liquidity after the GRC that had pushed the fed funds rate below the Fed's target range. To reduce the likelihood of below-target rates, the Overnight Reverse Repo Program (ON RRP) allows eligible counterparties to lend excess funds to the Fed through repo transactions, ensuring that repo rates remain close to or above the O/N RRP rate. The reverse repo facility is important for monetary policy during periods of high reserves when banks’ willingness to take on additional reserves diminishes, reducing the rates they pay for deposits and other funding.
...
Significant disruptions occurred with the Fed reduced its balance sheets after quantitative easing (QE). The Fed initiated the Standing Repo Facility (SRF) after the 2019 spike in repo, the FFR, and FX swap rates  exceeded the Fed’s upper target rate. Scarce bank reserves constrained dealer balance sheets, leading to cash shortage and a segmented repo market. The SRF lets primary dealers and other approved counterparties borrow cash from the Fed, secured against U.S. Treasuries. The Fed transformed the SRF into a permanent facility.
...
How monetary policy and the ON RRP facility interact with the private repo market is illustrated by MMFs use of the facility. 
The MMFs use of the ON RRP facility increased by $2 trillion between January 2021 and June 2022, MMFs'heir private repo lending fell by almost $500 billion. T
\url{https://www.federalreserve.gov/econres/notes/feds-notes/money-market-fund-repo-and-the-on-rrp-facility-20231215.html}

  Throughout 2022, the rate for dealers to borrow from cash lenders remained tightly pinned to O/N RRP.The Fed’s O/N RRP thus began to determine rates in tri-party repo. Repo rates must to rise above both O/N RRP and IORB for banks to fund repo trades with reserves, since they can earn IORB returns on reserves. When the spread between SOFR and IORB widens, financial participants  allocate cash to repo trades, supplying liquidity to the most crucial funding market. 
...
Beginning in 2023, the RRP balance was $2.5 trillion in excess liquidity. However, returns on large U.S. Treasury issuance in June 2023 exceeded the O/N RPP rate, ending the safe asset deficit. The RRP balance peaked as the primary RRP users, MMFs, bought Treasuries. 
 ...
 RRP balance has plunged below $800 billion,  12/14/2023.   (It is currently 	439.81, 5/31/2024).
<!--
...
## FOMC rates changes, monetary regimes, and events over the seven year period, 2016-2023 
Candidate shocks occurring during the seven year period of our sample 2016-2023 (Table \@ref{table_fomc}), include FOMC rate and administered rate changes, different policy experiments , events such as the March 2020 dash for cash, and macroeconomic announcements. 

The  Romer and Romer (2023) narrative approach to macroeconomic identification from quality sources,then incorporate the evidence into a statistical framework.  Their criteria formonetary shocks are times when monetary policymakers changed money growth and interest rates for reasons unrelated to current or prospective real economic  activity. These changeson policy are “shocks” in the sense that monetary policy is not being driven by output  or other factors affecting output.

However, this approach would exclude shocks such as policy changes such as QE, LSAP, and forward guidance or events such the spike in repo rates in 2019 or the March 2020 dash for cash. Changes in the Fed funds rate and the administered rates IORB and the reward rate ON RRP are one source of shocks to overnight reference rates (\@ref{table:FOMC rate changes 2016-2023}) 
...
Another source of shocks is found the literature began by (see Campbell et al., 2012) that identifies monetary policy shocks from changes of financial asset prices in a narrow time window around Federal Open Market Committee (FOMC) announcements. Public statements of FOMC intentions—forward guidance—can substitute for lower rates at the zero bound the issue they address. The authors distinguish between Odyssean forward guidance, which publicly commits the FOMC to a future action, and Delphic forward guidance, which merely forecasts macroeconomic performance and likely monetary policy actions. 
...
Jarocinski ()  estimates the structural shocks that underlie the reactions of financial market to FOMC announcements. While the nature of the shocks is not specified ex ante, ex post the estimated shocks can be naturally labeled as the current fed funds rate policy, an “Odyssean” forward guidance (a commitment to a future course of policy rates), a large scale asset purchase and a “Delphic” forward guidance (a statement about the future course of policy rates understood as a forecast of the appropriate stance of the policy rather than a commitment (see Campbell et al., 2012).
...
Monika Piazzesi (2005) takes this approach  in a continuous-time model of the joint distribution of bond yields and the FOMC interest rate target for the FFR, a linear-quadratic jump-diffusion model. With high-frequency data she provides information about the exact timing of FOMC meetings. This information can improve bond pricing and ability to identify monetary policy shocks. The short informational lag before Fed's policy decision, information available right before the FOMC meeting start provides a recursive identification scheme that turns the target forecast from right before the Federal Open Market Committee (FOMC) meeting into a high-frequency policy rule and the associated forecast errors into policy shocks
...
Overnight money market rates in funding markets share several features. They closely closely track and cluster around the Fed policy rate, the FFR. They respond quickly to changes in the EFFR or the administered rates IORB and O/N RRP (Figure \@ref(fig:Sample reference rates 3/4/2016-12/14/2023)). Their 
...
<!--
The vertical shifts in all rates suggest that daily rate and volume data from the New York Federal Reserve cover several policy regimes of the Fed.A recent Forbes article (adams, 2024) described policy regimes between 2016 to 2023 (\url{https://www.forbes.com/advisor/investing/fed-funds-rate-history/}) as
...
I have added the period of the zero lower bound. A more rigorous approach to identifying change in regimes is offered by (Valeria Gargiulo, Christian Matthes, and Katerina Petrova,2024) and (Bianchi, Ludvigson, and Ma, 2024).
...
Small IQRs indicate the FFR and money market rates are tightly clustered around their median values (Figure \@ref(fig:EFFR IQR and range of the sample 3/4/2016-12/14/2023)). Fifty percent of EFFR daily rates fall within 157.71-156.15 bp, an ICR of  1.56 basis points, the TGCR and BGCR cluster even more tightly, under one bp (133), SOHR  shows greater dispersion, 4.2 bp. (136.70-132.50).
...
\emph{Volume}
The volume of SOFR transactions, \$754 billion per day, dwarf trading in all other FFR and money market rates. EFFR has a notably lower daily trade volume of \$79 billion,  TGCR and BGCR at around \$300 billion each (TGCR 296.95, BGCR 311.23). (Figure \@ref(fig:Sample volumes of reference rates 3/4/2016-12/14/2023)). 
...
```{r, fig.cap="Sample reference rates 3/4/2016-12/14/2023", echo=FALSE,fig.num=TRUE, warning=FALSE, message=FALSE, results='asis'}
#sdate<-rrbp[,1]
...
```{r , fig.caption="EFFR IQR and range of the sample 3/4/2016-12/14/2023",echo=FALSE,warning=FALSE, message=FALSE, fig.num=TRUE,results='asis'}
...
```{r, fig.cap= "EFFR percentiles of the sample 3/4/2016-12/14/2023", echo=FALSE,fig.num=TRUE,warning=FALSE, message=FALSE,  results='asis'}
  library(ggplot2)
          sample<-quantilesE
          sdate <- quantilesE[, 1]
...
```{r, fig.cap= "Sample volumes of overnight rates 3/4/2016-12/14/2023", echo=FALSE,fig.num=TRUE,warning=FALSE, message=FALSE,  results='asis'}
y_breaks =25 
#str(vold)
...
# Generate the xtable with custom text sanitization
table_output <- capture.output(print(xtable(data), comment = FALSE, sanitize.text.function = identity))

# Remove lines that start with '%'
table_output <- table_output[!grepl("^%", table_output)]

# Print the cleaned LaTeX table
...
```{r,  fig.cap= "Volatility percent change daily rates 2016-2023", echo=FALSE,fig.num=TRUE,warning=FALSE, message=FALSE, results='asis'}
#env=my_envvolatile
library(ggplot2)
...
## Percentiles
Percentiles of the EFFR during the normalcy period  (Figure \@ref(fig:EFFR during normalcy period 3/4/2016-7/31/2019)). The EFFR, median and IQR values are withing the FOMC target ranges (the step function for the lower and upper target rates, TargetDe, and TargetUe). The IQR and outliers are illustrated Figure \@ref(fig:EFFR Key percentiles during normalcy period 3/4/2016-7/31/2019)


Percentiles of the EFFR during the adjustment period (Figure \@ref(fig:EFFR during adjustment period 8/1/2019-10/31/2019)). The outlier from the spike in repo rates September 2019 is the only time the FFR was not within the FOMC target range (Figure \@ref(fig:EFFR Key percentiles during mid cycle adjustment period 8/1/2019-10/31/2019)) and (Figure \@ref(fig:EFFR Key percentiles during mid cycle adjustment period 8/1/2019-10/31/2019)).

Percentiles of the EFFR during the pandemic (Figure \@ref(fig:EFFR during covid period 11/1/2019-3/16/2020)). The outliers from the March 20, 2020 dash for cash are outside the FOMC target rate (Figure \@ref(fig:EFFR Key percentiles during covid period 11/1/2019-3/16/2020)) and (Figure \@ref(fig:EFFR Key percentiles during covid period 11/1/2019-3/16/2020)).

Percentiles of the EFFR during the zero lower bound (Figure \@ref(fig:EFFR during zero lower bound (Zlb) period 3/17/2020-3/16/2022)) and (Figure \@ref(fig:EFFR Key percentiles during zero lower bond period  3/17/2020-3/16/2022)).
...
Percentiles of the EFFR during the Fed's fight to control inflation (Figure \@ref(fig:EFFR during inflation period 3/17/2022-12/14/2023)) The EFFR and the IQR are within the FOMC target rates (Figure \@ref(fig:EFFR Key percentiles during inflation period 3/17/2022-12/14/2023)) and (Figure \@ref(fig:EFFR Key percentiles during inflation period 3/17/2022-12/14/2023))
...
(see Percentiles of the EFFR during the normalcy period 3/4/2016-7/31/2019)
3/4/2016-7/31/2019)
...
<!--
(Figure \@ref(fig:Time series of rates by policy regime)).
...
xtable(charnorm, caption="Normalcy 3/04/2016-7/31/2019", caption.placement="top", comment = FALSE)
#print(xtable(charnorm), type = "latex", include.rownames = FALSE, caption.placement = "top", comment = FALSE)
```
<!--
Table \@ref(tab:Rate statistics normalcy 3/04/2016-7/31/2019) provides a summary of the data.
-->

```{r, tab.caption="Rate statistics normalcy 3/04/2016-7/31/2019", eval=TRUE,echo=FALSE, results='asis',warning=FALSE, message=FALSE}
begn <- c(1, 859, 923, 1014, 1519, 1)
endn <- c(858, 922, 1013, 1518, 1957, 1957)
library(xtable)
k <- 1 
...
xtable(normstats, caption="Normalcy 3/04/2016-7/31/2019", caption.placement="top", comment = FALSE)
#tabnorm<--xtable(normstats, caption="Normalcy 3/04/2016-7/31/2019", caption.placement="top")
#xtable(normstats[, -1], caption="Normalcy 3/04/2016-7/31/2019", caption.placement="top")
# Print the xtable object
#print(tabnorm, include.rownames = FALSE)
#print(xtable(normstats),type = "latex", include.rownames = FALSE, caption.placement = "top", comment = FALSE)
```
...
```{r, fig.caption= "Rates during normalcy 3/17/2016-7/31/2019",echo=FALSE,fig.num=TRUE,results='asis',warning=FALSE, message=FALSE}
library(ggplot2)
library(reshape2)
k=1
begn <- c(1, 859, 923, 1014, 1519, 1)
...
```{r, fig.caption= "EFFR during normalcy period 3/4/2016-7/31/2019", rates_norm,fig.num=TRUE, echo=FALSE, results='asis',warning=FALSE, message=FALSE}
library(ggplot2)
normE<-my_envepisodes$norm
sdate <- normE[, 1]
...
```{r, tab.caption="Rate characteristics mid cycle adjustment 8/1/2019-10/31/2019", echo=FALSE,results='asis',warning=FALSE, message=FALSE}
library(xtable)
k=2  
begn <- c(1, 859, 923, 1014, 1519, 1)
endn <- c(858, 922, 1013, 1518, 1957, 1957)
...
xtable(charadj,caption="Adjustment 8/1/2019-10/31/2019", caption.placement="top", comment = FALSE)
...
```{r, tab.caption="Rate statistics mid cycle adjustment 8/1/2019-10/31/2019",echo=FALSE,results='asis',warning=FALSE, message=FALSE}
library(xtable)
k=2  
begn <- c(1, 859, 923, 1014, 1519, 1)
endn <- c(858, 922, 1013, 1518, 1957, 1957)
...
xtable(adjstats, include.rownames = FALSE,caption="Adjustment 8/1/2019-10/31/2019", caption.placement="top", comment = FALSE)
...
```{r, fig.caption="Rates during mid cycle adjustment 8/1/2019-10/31/2019", echo=FALSE,fig.num=TRUE, results='asis',warning=FALSE, message=FALSE}
k=2  
library(ggplot2)
library(reshape2)
begn <- c(1, 859, 923, 1014, 1519, 1)
...
```{r, fig.caption= "EFFR during adjustment period 8/1/2019-10/31/2019", rates_adjust,eval=TRUE, echo=FALSE,fig.num=TRUE, results='asis',warning=FALSE, message=FALSE}
library(ggplot2)                        
library(reshape2)
...
```{r, tab.caption="Rate characteristics covid 11/1/2019-3/16/2020", echo=FALSE,results='asis',warning=FALSE, message=FALSE} 
library(xtable)
k=3  
begn<-c(1,859,923,1014,1519,1)
endn<-c(858,922,1013,1518,1957,1957)
...
xtable(charcovid, caption="Covid 03/17/2022-12/14/2023", caption.placement="top", comment = FALSE)
...
```{r, tab.caption="Rate statistics covid 11/1/2019-3/16/2020" , echo=FALSE,results='asis',warning=FALSE, message=FALSE}
library(xtable)
categories <- c("EFFR", "TGCR", "BGCR", "SOFR")
...
xtable(covidstats, include.rownames = FALSE,comment = FALSE)
...
```{r, fig.caption= "Rates during covid 11/1/2019-3/16/2020",echo=FALSE,fig.num=TRUE,results='asis',warning=FALSE, message=FALSE}
library(ggplot2)
library(reshape2)
k=3  
library(ggplot2)
...
```{r, fig.caption= "EFFR during covid period 11/1/2019-3/16/2020",rates_covid,echo=FALSE,fig.num=TRUE,results='asis',warning=FALSE, message=FALSE}
library(ggplot2)
rates=2
...
```{r, tab.caption="Rate characteristics zero lower bound 3/17/2020-3/16/2022", echo=FALSE, eval=TRUE, cache=FALSE,results='asis',warning=FALSE, message=FALSE}
library(xtable)
k=4  
begn<-c(1,859,923,1014,1519,1)
endn<-c(858,922,1013,1518,1957,1957)
...
xtable(charzlb,caption="Zero lower bound 03/17/2020-03/16/2022", caption.placement="top", comment = FALSE)
...
```{r, tab.caption="Rate statistics zero lower bound 3/17/2020-3/16/2022",echo=FALSE,results='asis',warning=FALSE, message=FALSE}
categories <- c("EFFR", "TGCR", "BGCR", "SOFR")
library(xtable)
...
xtable(zlbstats, include.rownames = FALSE,caption="Rate statistics Zero lower bound 03/17/2020-03/16/2022", caption.placement="top", comment = FALSE)
...
```{r, fig.caption= "Rates during zero lower bound 3/17/2020-3/16/2022",echo=FALSE,fig.num=TRUE,results='asis',warning=FALSE, message=FALSE}
library(ggplot2)
library(reshape2)
k=4 
library(ggplot2)
...
```{r, fig.caption= "EFFR during zero lower bound (zlb) period 3/17/2020-3/16/2022",rates_zlb,echo=FALSE,fig.num=TRUE,warning=FALSE, message=FALSE}
library(ggplot2)
...
```{r, tab.caption="Rate characteristics Taming inflation 03/17/2022-12/14/2023", echo=FALSE,results='asis',warning=FALSE, message=FALSE}
library(xtable)
k=5 
begn<-c(1,859,923,1014,1519,1)
endn<-c(858,922,1013,1518,1957,1957)
...
xtable(charinflation,caption="Taming inflation 03/17/2022-12/14/2023", caption.placement="top", comment = FALSE)
...
```{r, tab.caption="Rate statistics Taming inflation 03/17/2022-12/14/2023", echo=FALSE,results='asis',warning=FALSE, message=FALSE}
library(xtable)
k <- 5 
begn <- c(1, 859, 923, 1014, 1519, 1)
endn <- c(858, 922, 1013, 1518, 1957, 1957)
...
xtable(inflationstats, include.rownames = FALSE, caption="Rate statistics Taming inflation 03/17/2022-12/14/2023", caption.placement="top", comment = FALSE)
...
```{r, fig.caption= "Rates during Taming inflation 03/17/2022-12/14/2023",echo=FALSE,fig.num=TRUE,results='asis',warning=FALSE, message=FALSE}
library(ggplot2)
library(reshape2)
k=5
library(ggplot2)
...
```{r, fig.caption="EFFR during inflation period 3/17/2022-12/14/2023",rates_inflation,echo=FALSE,fig.num=TRUE,warning=FALSE, message=FALSE}
library(ggplot2)
library(reshape2)
...
```{r , fig.caption= "EFFR Key percentiles during normalcy period 3/4/2016-7/31/2019",echo=FALSE,fig.num=TRUE,results='asis'}
library(ggplot2)
...
```{r , fig.caption= "EFFR Key percentiles during mid cycle adustment period 8/1/2019-10/31/2019",echo=FALSE,fig.num=TRUE,results='asis'}
 library(ggplot2)
...
```{r , fig.caption= "EFFR Key percentiles during covid period 11/1/2019-3/16/2020",echo=FALSE,fig.num=TRUE,results='asis'}
 library(ggplot2)
...
```{r , fig.caption= "EFFR Key percentiles during zero lower bond period  3/17/2020-3/16/2022",echo=FALSE,fig.num=TRUE,results='asis'}
library(ggplot2)
...
```{r , fig.caption= "EFFR Key percentiles during inflation period 03/17/2022-12/14/2023",echo=FALSE,fig.num=TRUE,results='asis'}
library(ggplot2)
...
<!--
REVIEW AND DELETE
much lower during during covid,  between 1.3-1.4 bp and the zero lower bound. 0.12 and 0.15 bp. during the the zero lower bound 0.22 bp during normalcy;  (\@ref(tab: IQR of rates during policy regimes). The largest IQR is during the inflation regime, 3.3-3.4 bp, but still small. 

INFLATION The interquartile range for the money market rates TGCR and BGCR are 3.26-3.46 bp, smaller than the 1.62 bp of the policy rate, EFFR. 
...
<!--
Compare with sample discription, then delete
\emph{Variability: clustering of funding rates  around their median (IQR)}
...
<!--
During the pandemic (covid 11/1/2019-3/16/2020) until the Fed began its fight to contain inflation in 2023. 
From 2016 to 2020, the percent change in daily median overnight rights, is in the range of plus of minus 0.5 percent (see \@ref(fig:volatility Percent change Daily rates 2016-2023)).Volatility falls steadily during the fight against inflation
-->
