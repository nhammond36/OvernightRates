...
# Monetary policy during the sample period 2016-2023
  Before the Great Financial Crisis (GFC) of 2008, Federal Reserve conducted monetary policy policy by , trading reserves and securities in the interbank Federal Funds market through open market operations (OMO). The Fed response to the great financial crisis (GFC), large scale asset purchases (LSAPs) from 2008 to 2014 resulted in excess liquidity. Quantitative eeasing (QE),QE1, QE2, and QE3 was funded by US Treasury sale of Treasury bills. The Fed increased reserve balances from large part of its SOMA Treasury holdings. Swamped with reserves, banks had no need to borrow in the Fed Funds market. From 2010 to late 2019, reserves went through a full expansion-contraction cycle. Again in early 2020, reserves grew from $\$$8 trillion from 2010 and 2019 to \$19 trillion (2014 and 2021).
...
-->
 ...
 To keep the federal funds rate within the FOMC target range.the Fed offsets liquidity shocks with  repurchase (repo) and reverse repo transactions  Repurchase agreements drain reserves from the system and raise the FFR. Reverse repo purchases of assets by the Fed add reserves and lower the FFR.
...
After the Fed reduced its balance sheet built up after quantitative easing (QE),  repo rates. the FFR, and FX swap rates spiked in 2019, The FFR exceeded the Fed’s upper target rate. The Fed initiated the Standing Repo Facility (SRF) as low bank reserves constrained dealer balance sheets, leading to cash shortage and a segmented repo market. The SRF lets primary dealers and other approved counterparties borrow cash from the Fed, secured against U.S. Treasuries. The Fed transformed the SRF into a permanent facility.
