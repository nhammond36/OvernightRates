...
# Introduction
How monetary policy impacts money market rates in the market for repurchase agreements also reveals how the US central bank, the Federal Reserve, manages the policy rate, the Federal Funds rate (FFR). The administered rates for setting policy, interest on reserves (IORB) and the overnight reverse repo rate are also important tools for managing the FFR..

Events after the Great Financial Crisis (GFC), the excess liquidity created by quantitative easing, the spikes in repo and the FFR in 2019, the March 2020 dash for cash show how the adjustment of reserves (through the tri-party repurchase market) and the arbitrage opportunities between repo and the price of reserves affect credit and the economy.

The $4 trillion-a-day funding market through repurchase transactions provide liquidity to primary dealers, hedge funds, money market funds, government-sponsored enterprise (GSEs), banks, and private investors. The Fed also manages its policy rate as both a lender and borrower. Identifying the behavior and relation of rates in these markets is important to understanding the monetary system.  the tri-party general collaterial rate (TGCR), is repo’s primary funding market, the more lucrative OTC dealer to customer  broad general collateral rate (BGCR), and the Secured Overnight Financing Rate (SOFR), the Fed’s broadest measure of repo rates. In triparty repo, the “base layer” of repo markets. Here, nearly all players operate solely as cash lenders or borrowers.  The Federal Reserve is also active in triparty repo, as it uses the venue to conduct open market operations. The Fed is the only major participant to engage in both triparty repo borrowing and lending.Other participants obtain cash at the cheapest rates primarily from MMFs (money market funds) in triparty repo, then lend at a spread in other repo markets.
...
The policy and money market rates, share known qualities  of short rates
The Federal Reserve changes its policy rate, the Federal Funds rate and administered rates, 
and money market rates have similar features:
...
- The volatility of short rates survives  the Federal Reserve Bank's (Fed) 
management of of the Federal Funds rate (Bertolini, Prati)
-  Outliers fat tails
- arbitrage opportunities to invest in repo when SOFR exceeds IOR
...
The Federal Reserve manages the FFR with temporary borrowing, repurchase agreements  and lending, reverse repurchase agreements.Through repo and reverse repo transactions in the tri party market (TGCR), the Fed uses the  to adjust reserves and the FFR.  using repos to adding reserves to the system to lower the FFR or reverse repos to drain reserves raise FFR. (David Gibbs, Education Director Chicago Mercantile Exchange (CME). By trading securities with banks and other counterparites, Federal Reserve purchases or sales of assets from banks change the size of the Federal Reserve balance sheet. In a  repo transaction, 
...
Before the financial crisis of 2008, policy was implemented through changing reserves through open market operations where the Federal Reserve traded reserves and securities in the interbank federal funds market. Then came the Great Finance Crisis (GFC) where the Fed addressed the financial instablity and shocks to the economy with a flood  of asset purchases, quantitative easing, funded by US Treasury sail of Treasury bills.  Sated with this major increase in liquidity, the Fed tried different policy experiments to regain control over its policy rate, the Federal Funds rate (FFR). These experiments overlapped with the period of this study the FFR and money market rates from 2016 through 2023.

From 2010 to late 2019, reserves went through a full expansion-contraction cycle  and expanded 
again in early 2020, $\$$8 trillion from 2010 and 2019 to $\$$19 trillion (2014 and 2021) of banks’[?] assets. These movements reflect the Federal Reserve balance-sheet expansions in response to 
the 2008 and 2020 crises, as well as the interim normalization period from 2015 to 2019.
...
--- Concoda
the U.S, central bank’s QE (quantitative easing) replaced a large amount of the bank’s Treasury holdings in its System Open Market Account (SOMA)  with reserve balances.  The megabanks, primarily JPMorgan, become swamped in reserves absorbing most of the Fed’s QE purchases. There was no need to borrow in the Fed Funds market
----
in 2019, the FOMC abandoned active management of scarce reserves and other short term interest rates and adopted a policy of ample reserves to  manage the Fed Funds rate within its target range 
...
target range adopted by the FOMC in 2018.  October 1, 2008, Congress gave the Fed the power to pay interest on reserves (IORB) to help control the Federal Funds rate. The IORB rate, the interest rate that banks earn from the Fed on the funds deposited in their reserve accounts gave banks an incentive for a short term investment..The IORB is the Fed’s principal tool for interest rate control.  
In 2013, to address the post GFC build up of excess liquidity, the Federal Reserve introduced the O/N RRP facility providing the Fed’s supplementary tool for interest rate control. 

Its administrative rates comprise a floor system where  interest on reserves (IORB) 
...
But changes in these administered rates also change spreads change trading patterns in these funding markets. When SOFR  the Fed’s broadest measure of repo rates, exceeded O/N RRP, cash lenders returns to private repo, while the Fed’s facility took a backseat. When the spread between SOFR and IORB has widened/ significantly, funding market participants allocate cash to repo trades.
<!--
ALTERNATIVE TEXT
...
\emph(The Fed's involvement in repurchase market)
...
since the 1920s, The Fed has used repo transactions to manage the reserves held by commercial banks with the Fed. over time, repo operationS  became the Fed's primary means of adjusting bank reserves in order to influence the level and price of interbank credit as well as credit more broadly in the economy.manage the FFR in the interbank market?
...
The Fed's large scale asset purchases (LSAP), the response to the financial crisis of 2008,increased the supply of reserves through outright purchases of securities rather than repo transactions, making reserve requirements unnecessary:
- LSAP, funded largely by the issuance of new reserves, created post GFC excess liquidity and abundance of recereces, reducing the Fed's use of repos  altered reserves and the 
- The Fed's ability to pay interest on reserves (IORB) made reserves an attractive short-term investment.
...
To manage the FFR, the Fed temporarily intervenes in repurchase (repo) and reverse repo transactions to offset high frequency liquidity shocks to keep federal funds rate within the FOMC target range.
Repurchase agreements drain reserves from the system and raise the FFR. Reverse repo purchases of assets by the Fed add reserves and lower the FFR.

\emph{the reverse repurchase facility}
Fed opened its RRP (reverse repo) facility in 2013 to address this excess liquidity. The excess liquidity from reserves  push the fed funds rate below the bottom of the Fed's target range. To reduce the likelihood of below-target rates, the Fed introduced programmatic repo transactions with a wide range of financial firms in 2013. This program — the Overnight Reverse Repo Program (ON RRP) — allows eligible counterparties to lend excess funds to the Fed through repo transactions at a specified rate, ensuring that repo rates (and other short-term money market rates, by extension) remain close to or above the ON RRP rate.

Fed opened its RRP (reverse repo) facility in 2013. The O/N RRP accepts offers to lend cash against securities from its System Open Market Account (SOMA) portfolio.The reverse repo facility is available to a wide range of money market lenders.In a reverse repo transaction, the Desk sells securities to a counterparty subject to an agreement to repurchase the securities at a later date.  A reverse repo transaction temporarily in? decreases the supply of reserve balances in the banking system and lowers? raises the FFR. The reverse repo facility is important for monetary policy during periods of high reserves when banks’ willingness to take on additional reserves diminishes, and they reduce the rates they pay for deposits and other funding.  
...
Significant disruptions occurred during the period as the Fed reduced its balance sheets.
In 2019, repo, Fed Funds, and FX swap rates spiked during a cash shortage, prompted by scarce bank reserves, constrained dealer balance sheets, and a segmented repo market, surpassing the Fed’s upper rate boundaries. The Fed iniated the Standing Repo Facility (SRF) allowing the U.S. central bank’s primary dealers and other approved counterparties to borrow cash from the Fed, secured against U.S. Treasuries, and then distributed emergency funds to cash borrowers further down the hierarchy.  the Fed transformed the SRF into a permanent facility.
...
Concoda: from excess cash to excess collateral RRP, the sole shock absorber for excess liquidity
...
The median of the reference rates illustrate  how closely money market rates track the policy rate EFFR. They also demonstrate the how their central tendency changes with monetary policy. Average median rates for the sample are 157 bp for the EFFR, and some 133-134 bp for the money market rates and SOFR (top panel Table). 

During the periods of covid, the zero lower bound and the Fed's fight to control inflation, median money market rates TGCR and BGCR (149 bp) and SOFR (151 bp) are close to the median EFFR - 150.46, 8.09, and 368.60 bp.  During the normalcy and adjustment regimes, they diverge, 84-85 bp versus 134 bp of the EFFR. 
