...
<!--
was typically based on adjusting the scarcity value of a limited supply of central bank reserves. After the Great Financial Crisis (GFC), asset purchases under QE,QE1, QE2, and QE3, left the bank the looking for ways to manage the FFR after this major increase in liquidity.This challenge to the bank’s ability to control short-term interest rates led
...
To manage the build up in liquidity in reserves after the Great financial Crisis (GFC), 
-->

in 2019, the FOMC abandoned active management of scarce reserves and other short term interest rates and adopted a policy of ample reserve to  manage the Fed Funds rate within its target range adopted by the FOMC in 2018.Interest on reserves (IORB) mandated by Congress in 2018 paid on bank reserves  and a repurchase facility. In 2013, the Federal Reserve introduced the O/N RRP facility providing the Fed’s supplementary tool for interest rate control.  October 1, 2008, Congress gave the Fed the power to pay interest on reserves (IORB) to help control the Federal Funds rate. The IORB rate is the interest rate that banks earn from the Fed on the funds deposited in their reserve accounts.The IORB is the Fed’s principal tool for interest rate control.  
...
Concurrently, there has been a dramatic increase in funding primary dealers and other financial participants through repo and wholesale money market rates. Repo markets trade $\$$4 trillions of dollars daily. 
...
The Fed initiated a Standing Repo Facility (SRF) allowing the U.S. central bank’s primary dealers and other approved counterparties to borrow cash from the Fed, secured against U.S. Treasuries, and then distributed emergency funds to cash borrowers further down the hierarchy.  the Fed transformed the SRF into a permanent facility. The SRF provided dealers with liquidity after the September 2019 spike in repo rates Fed Funds, and FX swap rates during a cash shortage, prompted by scarce bank reserves, that constrained dealer balance sheets, and a segmented repo market, surpassing the Fed’s upper rate boundaries. ??? TheFFR >  IORB.  In the SRF, the Desk purchases securities from a counterparty subject to an agreement to repurchase the securities at a later date,  These purchases temporarily increase the supply of reserve balances in the banking system and lower the FFR.  Each repo transaction is economically similar to a loan collateralized by securities,interest” paid on that loan, is the difference between the original price and the second, higher price. 


Fed opened its RRP (reverse repo) facility in 2013. The O/N RRP accepts offers to lend cash against securities from its System Open Market Account (SOMA) portfolio.The reverse repo facility, the O/N RRP ,was established [to, in response to]. It is available to a wide range of money market lenders.In a reverse repo transaction, the Desk sells securities to a counterparty subject to an agreement to repurchase the securities at a later date.  A reverse repo transaction temporarily in? decreases the supply of reserve balances in the banking system and lowers? raises the FFR. The reverse repo facility is important for monetary policy during periods of high reserves when banks’ willingness to take on additional reserves diminishes, and they reduce the rates they pay for deposits and other funding.  
