...
```{r, tab.cap="Rate characteristics normalcy 3/4/2016-7/31/2019", echo=FALSE}
library(xtable)
k=1 
begn <- c(1, 859, 923, 1014, 1519, 1) 
endn <- c(858, 922, 1013, 1518, 1957, 1957) 
...
```{r, tab.caption="Rate statistics normalcy 3/04/2016-7/31/2019", echo=FALSE}
begn <- c(1, 859, 923, 1014, 1519, 1)
endn <- c(858, 922, 1013, 1518, 1957, 1957)
library(xtable)
k <- 1 
...
```{r,  tab.caption="Rate statistics mid cycle adjustment 8/1/2019-10/31/2019",echo=FALSE}
library(xtable)
k=2  
begn <- c(1, 859, 923, 1014, 1519, 1)
endn <- c(858, 922, 1013, 1518, 1957, 1957)
...
```{r, fig.caption= "EFFR during adjustment period 8/1/2019-10/31/2019", rates_adjust, echo=FALSE, results='asis'}
library(ggplot2)                        
library(reshape2)
...
```{r, tab.caption="Rate characteristics covid 11/1/2019-3/16/2020", echo=FALSE} 
library(xtable)
k=3  
begn<-c(1,859,923,1014,1519,1)
endn<-c(858,922,1013,1518,1957,1957)
...
```{r, tab.caption="Rate statistics covid 11/1/2019-3/16/2020" , echo=FALSE,cache=FALSE}
library(xtable)
...
```{r, tab.caption="Rate characteristics Taming inflation 03/17/2022-12/14/2023", echo=FALSE}
library(xtable)
k=5 
begn<-c(1,859,923,1014,1519,1)
endn<-c(858,922,1013,1518,1957,1957)
...
```{r, tab.caption="Rate statistics Taming inflation 03/17/2022-12/14/2023", echo=FALSE}
library(xtable)
k <- 5 
begn <- c(1, 859, 923, 1014, 1519, 1)
endn <- c(858, 922, 1013, 1518, 1957, 1957)
