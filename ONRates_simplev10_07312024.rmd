...
arima_df <- data.frame(
  ...
  bbp_params_Coefficients = c(NA, NA, -0.026, -0.018, 0.062, 0.206, -0.183, NA, NA, NA, NA, NA, NA, 0.718, 0.276),
  bbp_params_StdErrors = c(NA, NA, 0.017, 0.008, 0.018, 0.034, 0.078, NA, NA, NA, NA, NA, NA, 0.069, 0.042),
  bbp1994_params_Coefficients = c(0.600, NA, NA, NA, NA, 2.081, 2.913, NA, NA, NA, 0.713, NA, NA, NA, NA),
  bbp1994_params_StdErrors = c(0.038, NA, NA, NA, NA, 0.181, 0.331, NA, NA, NA, 0.262, NA, NA, NA, NA)
)
...
bpp_params <- c(ar1 = 0.844725586, intercept = 0, oneday_beforeholiday = 0.-026, 
                  threeday_beforeholiday = -0.018, oneday_afterholiday = 0.062, 
                  endquarter = 0, endyear = 0.0 Monday =0, 
                  Friday = 0, fomc = 0, fomcindex = 0, 
                  z = 0, nt = 0, absnu = 0, nu = 0) 

bpp_se <- c(ar1 = 0.844725586, intercept = 1.995289332, oneday_beforeholiday = 0.-026, 
                  threeday_beforeholiday = -0.018, oneday_afterholiday = 0.062, 
                  endquarter = 0, endyear = 0.0 Monday =0, 
                  Friday = 0, fomc = 0.009347913, fomcindex = 0, 
                  z = 0, nt = 0, absnu = 0, nu = 0) 


bpp1994_params <- c(ar1 = 0.6, intercept = 0, oneday_beforeholiday = 0.-026, 
                  threeday_beforeholiday = -0.018, oneday_afterholiday = 0.062, 
                  endquarter = 0, endyear = 0.0 Monday =0, 
                  Friday = 0, fomc = 0, fomcindex = 0.713, 
                  z = 0, nt = 0, absnu = 0.718, nu = 0.276) 

bpp1994_se <- c(ar1 = 0.844725586, intercept = 1.995289332, oneday_beforeholiday = 0.-026, 
                  threeday_beforeholiday = -0.018, oneday_afterholiday = 0.062, 
                  endquarter = 0, endyear = 0.0 Monday =0, 
                  Friday = 0, fomc = 0.009347913, fomcindex = 0, 
                  z = 0, nt = 0, absnu = 0, nu = 0) 
