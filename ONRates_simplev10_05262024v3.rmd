...
- Arbitrage opportunities exist to invest in repo when SOFR exceed IORB, the interest banks can receive on   deposits with the Fed
   ...
   There are several ways he level of reserves in the banking system can change:
...
Overnight money market rates in funding markets closely cluster around  and track the Fed policy rates, the  FFR. They respond quickly to changes in the EFFR or the administered rates IORB and O/N RRP (Figure \@ref(fig:Sample reference rates 3/4/2016-12/14/2023)). What are the properties of these rates? The medians change over time, their interquartile range (IQR) indicates low variablity, closely clustering around their medians. Outliers characteristic fat tailed distributions. Rates are heteroskedastics - Volatility as measured by percent change in their medians varies over time.
<!--
...
The daily rate and volume data from the New York Federal Reserve cover several policy regimes of the FED from 2016 through 2023 -a period of normalcy with sequential 25 basis point (bp) increases from 2016 to mid 2019,a mid cycle adjustment with plus or minus 25 bp from August to November 2019, a series of 25 bp increased with QE during covid from November 2019  to mid March 2020,  a period of the zero lower bound, and sequential rate increases during the taming of inflation mid March 2022 to mid Decemebr 2023.
...
<!--
Times series of rates during different policy episodes portray how the distribution of rates changes with monetary policy (Figure \@ref(fig:Time series of rates by policy regime)).
-->
...
The median of the reference rates illustrate  how closely money market rates track the policy rate EFFR. Their rates during different episodes demonstrate the how their central tendency changes with monetary policy. Average median rates for the sample are 157 bp for the EFFR, and some 133-134 bp for the money market rates and SOFR (top panel Table). 
...
A measure of central tendency, the median illustrate the change in central tendency of rates during difference policy episodes (\@ref(tab:Rate characteristics 2016-2023). The average median EFFR over the full sample is 157 bp.  The money market rates about 132-134 bp, TGCR  132  bp,  BGCR 133 bp, SOFR 134 bp. 
...
The difference in the central tendencies as measured by the median rate, changes dramatically over different policy episodes.  The sample EFFR  157 bp drops to 134 bp during the normalization period, 184 bp in the adjustment period bp,  150.46 bp during covid,  8.09 bp the zero lower bound, and some 235 percent of the median rate during the sample -  369 bp during the inflation fighting period
