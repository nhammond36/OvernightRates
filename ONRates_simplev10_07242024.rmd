...
- Arbitrage opportunities exist to invest in repo when SOFR exceed IORR, the interest banks can receive on   deposits with the Fed
   ...
   The level of reserves in the banking system changes when the Fedresponds to volatility in the federal funds market by adjusting the reserve supply to keep the federal funds rate within its target range through daily repo and reverse repo operations. Reserves can also change
