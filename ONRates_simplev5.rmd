...
```{r, tab.caption="Rate statistics normalcy 3/04/2016-7/31/2019", echo=FALSE,results='asis'}
begn <- c(1, 859, 923, 1014, 1519, 1)
endn <- c(858, 922, 1013, 1518, 1957, 1957)
library(xtable)
k <- 1 
...
xtable(normstats, include.rownames = FALSE, caption="Normalcy 3/04/2016-7/31/2019", caption.placement="top")
```
...
```{r, fig.caption= "EFFR during normalcy period 3/4/2016-7/31/2019", rates_norm, echo=FALSE, results='asis'}
library(ggplot2)
normE<-my_envepisodes$norm
sdate <- normE[, 1]
...
```{r, tab.caption="Rate characteristics covid 11/1/2019-3/16/2020", echo=FALSE, cache=FALSE, results='asis'}
library(xtable)
k=3  
begn<-c(1,859,923,1014,1519,1)
endn<-c(858,922,1013,1518,1957,1957)
...
```{r, tab.caption="Rate statistics covid 11/1/2019-3/16/2020" , echo=FALSE,cache=FALSE, results='asis'}
library(xtable)
...
```{r, fig.caption="EFFR during inflation period 3/17/2022-12/14/2023",rates_inflation,
