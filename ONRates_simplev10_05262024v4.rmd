...
```{r , fig.caption="EFFR IQR and range of the sample 3/4/2016-12/14/2023",echo=FALSE,fig.num=TRUE,results='asis'}
...
```{r, fig.cap= "EFFR percentiles of the sample 3/4/2016-12/14/2023", echo=FALSE,fig.num=TRUE, results='asis'}
  library(ggplot2)
          sample<-quantilesE
          sdate <- quantilesE[, 1]
...
```{r,  fig.cap= "Volatility percent change daily rates 2016-2023", echo=FALSE,fig.num=TRUE,results='asis'}
#env=my_envvolatile
library(ggplot2)
