...
Section 2 reviews the time series properties of daily policy and money market rates, and transactions and reserves held at the Federal Reserve from 3/4/2016-12/14/2023. Section 3 describes rate behavior during different policy episodes.  Section 3 discusses methodology. Section 4 Results.  Section 5 Conclusions.  Sections 3-5 are in progress.
...
## Monetary policy during the sample period 2016-2023
  ...
  To regain control over the FFR after this major increase in liquidity, the Fed experimented with with different policies during the seven year period of our sample 2016-2023. Quantitative tightening and occurred during ..? [THESE ARE They are relate to episodes] QE4
...
# Behavior FFR and money market rates during different policy episodes
<!--
...
xtable(normstats, caption="Normalcy 3/04/2016-7/31/2019", caption.placement="top")
...
#print(xtable(normstats),type = "latex", include.rownames = FALSE, caption.placement = "top")
```
...
The vertical shifts in rates throughout  from 2016 to 2023 suggest changes in distribution of rates during difference policy episodes (Figure \@ref(fig:Time series of rates by policy regime)).The average median rates and percentiles illustrate the tendency of other rates to cluster around the EFFR.

<!--
The following policy episodes were discussed in a Forbes article
-->
