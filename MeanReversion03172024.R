...
# DAILY DATA Plots and sample stats -------------------------------------------------------------------
y_breaks=25
y_limits=500
...
quantilesE<-spread_no_na[,c("EFFR","VolumeEFFR","TargetUe","TargetDe","Percentile01_EFFR","Percentile25_EFFR","Percentile75_EFFR","Percentile99_EFFR","sdate")]
...
quantilesE2<-select(spread_no_na,EFFR,VolumeEFFR,TargetUe,TargetDe,Percentile01_EFFR,Percentile25_EFFR,Percentile75_EFFR,Percentile99_EFFR,sdate)

library(dplyr)
quantilesE2 <- spread_no_na %>%
  mutate(sdate = as.Date(sdate))

quantilesE2 <- select(quantilesE2, sdate, EFFR, TargetUe, TargetDe, Percentile01_EFFR, Percentile25_EFFR, Percentile75_EFFR, Percentile99_EFFR)
...
quantilesEnum <- quantilesE[, 2:9]
# Note I already made moved sdate from last to first col 
# but here's how to do it quantilesE <- quantilesE[, c("sdate", setdiff(names(quantilesE), "sdate"))]
# Print the structure of the modified data frame
str(quantilesE)
quantilesOnum <- quantilesO[, 2:7]
quantilesTnum <- quantilesT[, 2:7]
quantilesBnum <- quantilesB[, 2:7]
quantilesSnum <- quantilesS[, 2:7]

Estats <- colMeans(quantilesEnum, na.rm = TRUE)
Ostats <- colMeans(quantilesOnum, na.rm = TRUE)
Tstats <- colMeans(quantilesTnum, na.rm = TRUE)
Bstats <- colMeans(quantilesBnum, na.rm = TRUE)
Sstats <- colMeans(quantilesSnum, na.rm = TRUE)
...
# DELETE?
selected_columnsE <- Estats[c("EFFR","VolumeEFFR","Percentile01_EFFR","Percentile25_EFFR","Percentile75_EFFR","Percentile99_EFFR")]
selected_columnsS <- Sstats[c("SOFR","VolumeSOFR","Percentile01_SOFR", "Percentile25_SOFR","Percentile75_SOFR","Percentile99_SOFR")]
...
Tstats_mat <- matrix(Tstats, nrow = 8, ncol = 1)
Bstats_mat <- matrix(Bstats, nrow = 8, ncol = 1)
Sstats_mat <- matrix(Sstats, nrow = 8, ncol = 1)

# Combine the matrices into one matrix
stats <- cbind(Estats_mat, Tstats_mat, Bstats_mat, Sstats_mat)

# Print the combined matrix
print(stats)
# Set row names
rownames(stats) <- c("Rate", "Volume", "Upper target", "Lower target", 
                     "Percentile_01", "Percentile_25", "Percentile_75", "Percentile_99")

# Set column names
colnames(stats) <- c("EFFR", "TGCR", "BGCR",  "SOFR")
...
volume=c(volumessample[1],volumessample[2],volumessample[3],volumessample[4])
ratesamplestats <- data.frame(Category = categories, Median = median_values, IQR = iqr_values, RANGE=range_values, VOLUME=volume)
ratesamplestats_table <- xtable(ratesamplestats)
print(ratesamplestats_table )
...
sdate[endn]
#[1] "2019-07-31" "2019-10-31" "2020-03-16" "2022-03-16" "2023-12-14" "2023-12-14"
sdate[begn]
#[1] "2016-03-04" "2019-08-01" "2019-11-01" "2020-03-17" "2022-03-17" "2016-03-04"


# ------------------------ ADD TO VOLATILITY PLOTS
k=6
bgn<-begn[k]
edn<-endn[k]-1
...
ggplot(df_long, aes(x = sdate, y = Value, color = Variable)) +
  ...
  df$OBFR <- NULL # drop OBFR from data frame
...
# Save the environment to an RDS file
saveRDS(my_episodes, file = "C:/Users/Owner/Documents/Research/OvernightRates/my_envepisodes.RDS")
...
# Combine the matrices into one matrix
statsnorm <- cbind(Estatsnorm_mat, Tstatsnorm_mat, Bstatsnorm_mat, Sstatsnorm_mat)
print(statsnorm)
# Set row names
rownames(statsnorm) <- c("Rate", "Volume", "Upper target", "Lower target", 
                     "Percentile_01", "Percentile_25", "Percentile_75", "Percentile_99")

colnames(statsnorm) <- c("EFFR", "TGCR", "BGCR",  "SOFR")
print(statsnorm)



##
# episode characteristics old---------------------------------
selected_columnsE <- Estatsnorm[c("EFFR","VolumeEFFR","Percentile01_EFFR", "Percentile25_EFFR","Percentile75_EFFR","Percentile99_EFFR")]
normcharE <- rbind(selected_columnsE, Tstatsnorm, Bstatsnorm,Sstatsnorm)
normcharE_table <- xtable(normcharE)
print(normcharE_table)

normcharE2_table <- xtable(selected_columnsE)
print(normcharE2_table)

selected_columnsT <- Tstatsnorm[c("TGCR","VolumeTGCR","Percentile01_TGCR", "Percentile25_TGCR","Percentile75_TGCR","Percentile99_EFFR")]
normcharT <- rbind(selected_columnsE, Tstatsnorm,Bstatsnorm,Sstatsnorm)
normcharT_table <- xtable(normcharT)
print(normcharT_table)

selected_columnsB <- Bstatsnorm[c("BGCR","VolumeBGCR","Percentile01_BGCR", "Percentile25_BGCR","Percentile75_BGCR","Percentile99_BGCR")]
normcharB <- rbind(selected_columnsE, Tstatsnorm,Bstatsnorm,Sstatsnorm)
normcharB_table <- xtable(normcharB)
print(normcharB_table)

selected_columnsS <- Sstatsnorm[c("SOFR","VolumeSOFR","Percentile01_SOFR", "Percentile25_SOFR","Percentile75_SOFR","Percentile99_SOFR")]
normcharS <- rbind(selected_columnsE, Tstatsnorm,Bstatsnorm,Sstatsnorm)
normcharS_table <- xtable(normcharS)
print(normcharS_table)


normcharE<-cbind(selected_columnsE,selected_columnsT,selected_columnsB,selected_columnsS)
normcharE_table <- xtable(selected_columnsE[,2:ncol(selected_columnsE)])
print(normcharE_table)
...
normstats_table <- xtable(normstats)
print(normstats_table)
...
# Combine the matrices into one matrix
statsadj <- cbind(Estatsadj_mat, Tstatsadj_mat, Bstatsadj_mat, Sstatsadj_mat)
print(statsadj)
# Set row names
rownames(statsadj) <- c("Rate", "Volume", "Upper target", "Lower target", 
                     "Percentile_01", "Percentile_25", "Percentile_75", "Percentile_99")

colnames(statsadj) <- c("EFFR", "TGCR", "BGCR",  "SOFR")
print(statsadj)
...
adjstats_table <- xtable(adjstats)
print(adjstats_table)
...
# Combine the matrices into one matrix
statscovid <- cbind(Estatscovid_mat, Tstatscovid_mat, Bstatscovid_mat, Sstatscovid_mat)
print(statscovid)
# Set row names
rownames(statscovid) <- c("Rate", "Volume", "Upper target", "Lower target", 
                     "Percentile_01", "Percentile_25", "Percentile_75", "Percentile_99")

colnames(statscovid) <- c("EFFR", "TGCR", "BGCR",  "SOFR")
print(statscovid)
...
covidstats_table <- xtable(covidstats)
print(covidstats_table)
...
# Combine the matrices into one matrix
statszlb <- cbind(Estatszlb_mat, Tstatszlb_mat, Bstatszlb_mat, Sstatszlb_mat)
print(statszlb)
# Set row names
rownames(statszlb) <- c("Rate", "Volume", "Upper target", "Lower target", 
                     "Percentile_01", "Percentile_25", "Percentile_75", "Percentile_99")

colnames(statszlb) <- c("EFFR", "TGCR", "BGCR",  "SOFR")
print(statszlb)
...
zlbstats_table <- xtable(zlbstats)
print(zlbstats_table)
...
# Combine the matrices into one matrix
statsinflation <- cbind(Estatsinflation_mat, Tstatsinflation_mat, Bstatsinflation_mat, Sstatsinflation_mat)
print(statsinflation)
# Set row names
rownames(statsinflation) <- c("Rate", "Volume", "Upper target", "Lower target", 
                     "Percentile_01", "Percentile_25", "Percentile_75", "Percentile_99")

colnames(statsinflation) <- c("EFFR", "TGCR", "BGCR",  "SOFR")
print(statsinflation)
...
inflationchar_table <- xtable(inflationchar)
print(inflationchar_table)
...
inflationstats_table <- xtable(inflationstats)
print(inflationstats_table)
library(xtable)

# Assuming x1, x2, x3, ... are your xtable objects
# Example xtable objects
x1 <- xtable(data.frame(A = 1:3, B = letters[1:3]))
x2 <- xtable(data.frame(C = 4:6, D = letters[4:6]))
x3 <- xtable(data.frame(E = 7:9, F = letters[7:9]))

# Combine xtable objects
combined_xtable <- rbind(x1, x2, x3)
episodesstats_xtable <-rbind(normstats_table, adjstats_table,covidstats_table, zlbVstats_table,inflationstats_table)
episodeschar_xtable <-rbind(normchar_table, adjchar_table,covidchar_table, zlbVchar_table,inflationchar_table)

# Print the combined xtable
print(combinedepisodes_xtable)
...
# https://www.rdocumentation.org/packages/ggplot2/versions/3.4.4/topics/geom_quantile
# https://ggplot2.tidyverse.org/reference/geom_violin.html
  boxeffr <- data.frame(
    x = 1,
    y0 = min(quantilesE$EFFR),
    y25 = quantile(quantilesE$Percentile25_EFFR,0.25),
    y50 = median(quantilesE$EFFR),
    y75 = quantile(quantilesE$Percentile75_EFFR,0.75),
    y100 = max(quantilesE$EFFR)
  )
  

  be<- ggplot(boxeffr, aes(x)) +
    geom_boxplot(
      #aes(ymin = y0, lower = Percentile25_EFFR, middle = EFFR, upper = Percentile75_EFFR, ymax = y100),
...
boxplot_sample <- data.frame(
  ...
  ggsave("C:/Users/Owner/Documents/Research/MonetaryPolicy/Figures/Figures2/bsample.pdf")
  ggsave("C:/Users/Owner/Documents/Research/MonetaryPolicy/Figures/Figures2/bsample.png")
...
boxplot_normalcy <- data.frame(
  ...
  my_environmentbox$norm <-boxplot_normalcy
  ...
  ggsave("C:/Users/Owner/Documents/Research/MonetaryPolicy/Figures/Figures2/bnormalcy.pdf")
  ggsave("C:/Users/Owner/Documents/Research/MonetaryPolicy/Figures/Figures2/bnormalcy.png")
  ...
  my_environmentbox$adjust <-boxplot_adjust
  ...
  ggsave("C:/Users/Owner/Documents/Research/MonetaryPolicy/Figures/Figures2/badjust.pdf")
  ggsave("C:/Users/Owner/Documents/Research/MonetaryPolicy/Figures/Figures2/badjust.png")
  ...
  my_environmentbox$covid <-  boxplot_covid
  ...
  ggsave("C:/Users/Owner/Documents/Research/MonetaryPolicy/Figures/Figures2/bcovid.pdf")
  ggsave("C:/Users/Owner/Documents/Research/MonetaryPolicy/Figures/Figures2/bcovid.png")
  ...
  bzlb<-ggplot(boxplot_zlb , aes(x=Group,
    ...
    geom_boxplot(stat = "identity")   
  print(bzlb)
  my_environmentbox$zlb <-  boxplot_zlb
  ...
  ggsave("C:/Users/Owner/Documents/Research/MonetaryPolicy/Figures/Figures2/bzlb.pdf")
  ggsave("C:/Users/Owner/Documents/Research/MonetaryPolicy/Figures/Figures2/bzlb.png")
  ...
  binflation<-ggplot(boxplot_inflation , aes(x=Group,
    ...
    geom_boxplot(stat = "identity")   
  print(binflation)
  my_environmentbox$inflation <-boxplot_inflation
  ...
  ggsave("C:/Users/Owner/Documents/Research/MonetaryPolicy/Figures/Figures2/binflation.pdf")
  ggsave("C:/Users/Owner/Documents/Research/MonetaryPolicy/Figures/Figures2/binflation.png")
...
##  
  boxsofr <- data.frame(
    x = 1,
    y0 = min(quantilesS$SOFR),
    y25 = quantile(quantilesS$Percentile25_SOFR,0.25),
    y50 = median(quantilesS$SOFR),
    y75 = quantile(quantilesS$ercentile75_SOFR,0.75),
    y100 = max(quantilesS$SOFR)
  )
