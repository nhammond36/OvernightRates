...
```{r, load_environment_episodes, echo=FALSE}
# Load RDS file using relative file path
my_envepisodes <- readRDS("path/to/my_envepisodes.RDS")

-->

str(my_envepisode$sampleE)
...
Figure \@ref(fig:EFFR and quantiles)
{r EFFR and quantiles, fig.cap= "EFFR and quantiles 2016-2023",echo=FALSE}
#Access the data frame stored in the environment
...
```{r SOFR and targets, fig.cap= "SOFR, FOMC targets 2016-2023", echo=FALSE}
...
Table \@ref(tab:normtable_characteristics) provides a summary of the data.
```{r norm_characteristics, tab.cap="Rate characteristics 2016-2023", echo=FALSE, results='asis'}
k=1 # normalcy period
...
```{r norm_metrics, tab.cap="Rate characteristics 2016-2023", echo=FALSE, results='asis'}
# episode stats --------------------------------------------------------
...
```{r covidttable_characteristics, tab.cap="Rate characteristics 2016-2023", echo=FALSE, results='asis'}
# Covid period --------------------------------------
k=3  
bgn<-begn[k]
edn<-endn[k]
...
```{r covid_stas, tab.cap="Rate statistics 2016-2023", echo=FALSE, results='asis'}
...
```{r zlb_metrics, tab.cap="Rate characteristics 2016-2023", echo=FALSE, results='asis'}
