...
(Table (\@ref(tab:samplevar))
<!--
```{r,samplevar,  echo=FALSE, results='asis',warning=FALSE, message=FALSE}
```{r example_chunk}
# Display the betas matrix
print(betas_matrix)
```
```
...
result <- list(
  ...
  ), nrow = 5, byrow = TRUE, dimnames = list(c("EFFR", "TGCR", "BGCR", "SOFR", "ones_v"), c("EFFR", "TGCR", "BGCR", "SOFR")))
)

# Assign the betas matrix to a variable
betas_matrix <- result[[1]]
```

#### RMarkdown Document (`example.Rmd`)
