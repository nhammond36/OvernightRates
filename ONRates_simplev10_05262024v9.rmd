...
\emph{VAR of daily rates EFFR, TGCR, BGCR, SOFR} The EFFR at a daily frequency is mean reverting, but has small influence on other rates with coefficients around 0.14. The money market rates load around 2 on the EFFR, the TGCR positively 2.1, the BGCR a negative 2.02.  They load on each other and SOFR, again TGCR positively, BGCR negatively. SOFR loads a small -.08 on the EFFR, but positively on the money market rates.
...
mu      0.000000    0.000000  -0.004848  0.99613
ar1     0.002852    0.000272  10.465322  0.00000
omega  -0.381938    0.019067 -20.031004  0.00000
alpha1 -0.541177    0.103694  -5.218990  0.00000
beta1   0.902623    0.002823 319.747033  0.00000
gamma1  0.812176    0.064852  12.523500  0.00000
shape   0.113474    0.000906 125.248149  0.00000

Robust Standard Errors:
        Estimate  Std. Error   t value Pr(>|t|)
mu      0.000000    0.000039 -0.000012 0.999990
ar1     0.002852    0.006583  0.433168 0.664893
omega  -0.381938    0.127277 -3.000838 0.002692
alpha1 -0.541177    0.434317 -1.246039 0.212750
beta1   0.902623    0.019047 47.389363 0.000000
gamma1  0.812176    0.326126  2.490372 0.012761
shape   0.113474    0.009091 12.481586 0.000000
...
------------------------------------
                        statistic  p-value
Lag[1]                      3.843 0.049967
Lag[2*(p+q)+(p+q)-1][2]     3.843 0.006071
Lag[4*(p+q)+(p+q)-1][5]     3.884 0.244552
d.o.f=1
...
------------------------------------
                        statistic p-value
Lag[1]                    0.01287  0.9097
Lag[2*(p+q)+(p+q)-1][5]   0.04599  0.9996
Lag[4*(p+q)+(p+q)-1][9]   0.07628  1.0000
d.o.f=2

Weighted ARCH LM Tests
------------------------------------
            Statistic Shape Scale P-Value
ARCH Lag[3]   0.01580 0.500 2.000  0.9000
ARCH Lag[5]   0.03956 1.440 1.667  0.9965
ARCH Lag[7]   0.05896 2.315 1.543  0.9998

Nyblom stability test
------------------------------------
Joint Statistic:  631.8911
...
------------------------------------
                   t-value   prob sig
Sign Bias          0.18050 0.8568    
Negative Sign Bias 0.09187 0.9268    
Positive Sign Bias 0.34321 0.7315    
Joint Effect       0.17200 0.9820    
...
Elapsed time : 1.776356 

I will replicate Bertola et al EGARCH. 
<!--
with little success but will continue to find a first estimate for comparison with other methods.
-->

<!--
?
var_sample<<- xtable(bvtablek1, caption = "VAR sample rates 3/4/2016 to 12/14/2023", label="tab:samplevar", caption.placement="bottom", comment = FALSE)
colnames(var_sample) <- categories
-->
