...
found evidence that stock returns are negatively correlated with changes in
 ...
 returns higher than expected).4 GARCH models, however, assume that only the
...
All significant except constant $\mu$.  Negative alpha1 and positive beta1 imply oscillatory behavior.
...
<!--
with little success but will continue to find .
-->
